###############################################
#             Code made by Hubgames           #
#        https://github.com/thehubgames       #
#           Copyright© Hubgames, 2023         #
...
# Owner ID
owner_ids = [457275321171968000, 574169911782277135, 1096110516507770890] # You can add more owner ids by adding a comma and the id
